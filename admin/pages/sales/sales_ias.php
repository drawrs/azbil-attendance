...
<div class="wrapper">
    <header class="main-header">
      ...
      <span class="logo-mini"><b>IAS</b></span>
      <span class="logo-lg"><b>Dashboard</b></span>
      </a>

    <!--Header Navbar: bagian membuat log on-->
      ...
      <!-- User image -->
        <li class="user-header">
            <img src="../../dist/img/logo.jpg" class="img-circle" alt="User Image">
              ...
              <a href="../../index.php" class="btn btn-default btn-flat">BACK</a>
            </header>
...
<!--halamana navigasi menu-->
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
    <li class="active">SALES-IAS</li>
  </ol>
  </section>
  </div>
<!--class footer-->
